...
<title>微管家安装向导(三)</title>
<link rel="stylesheet" href="css/install.css" />
<script type='text/javascript' src='javascript/jquery-1.4.4.min.js'></script>
</head>
<body>
<div class="container">
	<div class="head"><img src="images/log.gif" width="354" height="53" alt="iWebShop安装向导" /></div>
					...
					<div class="gray_box">
						<div class="box">
							<table class="form_table">
								...
								<tr>
									<th>数据库表前缀</th>
									<td><input class="gray" type="text"   name='db_pre'  value="wg_"/><br /><label class="error" id='db_pre_label' style='display:none'><img src="images/failed.gif" width="16" height="15" />请填写正确的表前缀字符</label></td>
								</tr>
								<tr>
